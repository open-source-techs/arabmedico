    ...
    <section class="content-header">
        ...
        <div class="header-title">
            ...
            <ol class="breadcrumb hidden-xs">
                ...
                <li class="active">Candidates Application</li>
            </ol>
        </div>
    </section>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <?php
                                    $sql = query("SELECT * FROM tbl_job_application a JOIN tbl_job j ON (j.job_id = a.job_app_no) WHERE j.job_employeer = $emp_id AND a.job_app_status = 0");
                                    while ($row = fetch($sql))
                                    {
                                        ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= admin_base_url();?>model/jobModel?act=app_stat&app=<?= $row['job_app_id'] ?>&val=1" class="btn btn-success btn-xs">Approve</a>
                                                <a href="<?= admin_base_url();?>model/jobModel?act=app_stat&app=<?= $row['job_app_id'] ?>&val=2" class="btn btn-danger btn-xs">Reject</a>
                                                <a href="<?= admin_base_url();?>model/jobModel?act=app_stat&app=<?= $row['job_app_id'] ?>&val=3" class="btn btn-warning btn-xs">Hold</a>
                                            </td>
                                        </tr>
                                        <?php
                                    }
                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <?php
                                    $sql = query("SELECT * FROM tbl_job_application a JOIN tbl_job j ON (j.job_id = a.job_app_no) WHERE j.job_employeer = $emp_id AND a.job_app_status = 1");
                                    while ($row = fetch($sql))
                                    {
                                        ?>
                                        <tr>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <?php
                                    $sql = query("SELECT * FROM tbl_job_application a JOIN tbl_job j ON (j.job_id = a.job_app_no) WHERE j.job_employeer = $emp_id AND a.job_app_status = 3");
                                    while ($row = fetch($sql))
                                    {
                                        ?>
                                        <tr>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <?php
                                    $sql = query("SELECT * FROM tbl_job_application a JOIN tbl_job j ON (j.job_id = a.job_app_no) WHERE j.job_employeer = $emp_id AND a.job_app_status = 4");
                                    while ($row = fetch($sql))
                                    {
                                        ?>
                                        <tr>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <?php
                                    $sql = query("SELECT * FROM tbl_job_application a JOIN tbl_job j ON (j.job_id = a.job_app_no) WHERE j.job_employeer = $emp_id AND a.job_app_status = 5");
                                    while ($row = fetch($sql))
                                    {
                                        ?>
                                        <tr>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <?php
                                    $sql = query("SELECT * FROM tbl_job_application a JOIN tbl_job j ON (j.job_id = a.job_app_no) WHERE j.job_employeer = $emp_id AND a.job_app_status = 6");
                                    while ($row = fetch($sql))
                                    {
                                        ?>
                                        <tr>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <?php
                                    $sql = query("SELECT * FROM tbl_job_application a JOIN tbl_job j ON (j.job_id = a.job_app_no) WHERE j.job_employeer = $emp_id AND a.job_app_status = 7");
                                    while ($row = fetch($sql))
                                    {
                                        ?>
                                        <tr>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <?php
                                    $sql = query("SELECT * FROM tbl_job_application a JOIN tbl_job j ON (j.job_id = a.job_app_no) WHERE j.job_employeer = $emp_id AND a.job_app_status = 8");
                                    while ($row = fetch($sql))
                                    {
                                        ?>
                                        <tr>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <?php
                                    $sql = query("SELECT * FROM tbl_job_application a JOIN tbl_job j ON (j.job_id = a.job_app_no) WHERE j.job_employeer = $emp_id AND a.job_app_status = 2");
                                    while ($row = fetch($sql))
                                    {
                                        ?>
                                        <tr>
