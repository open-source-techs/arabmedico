                    ...
                    <div class="panel-body">
                        <form  action="<?= admin_base_url()?>model/doctorModel" method="POST" enctype="multipart/form-data" class="col-sm-12">
                            ...
                            <div class="col-sm-6 form-group">
                                ...
                                <div class="col-sm-12">
                                    <img src="<?= file_url().$doc['doc_logo'];?>" style="height: 50px; width: 100px;">
                                </div>
                            </div>
                            <div class="col-sm-6 form-group">
                        ...
                        <div class="row">
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        <?php
                                        $sql = query("SELECT * FROM tbl_doc_slider where doc_slider_doc = '$doc_id'");
                                        $i=0;
                                        while ($row = fetch($sql))
                                        {
                                            $i++;
                                            ...
                                            <tr>
                                                <td><?= $i; ?></td>
                                                <td><?= $row['doc_slider_title']; ?></td>
                                                <td><img style="width:100px;height:auto" src="<?= file_url().$row['doc_slider_image'];?>"></td>
                                                <td>
                                                    <a href="<?= admin_base_url();?>model/doctorModel?act=del-slide&sld_id=<?= $row['doc_slider_id']; ?>" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i></a>
                                                </td>
                                            </tr>
                                            <?php
                                        }
                        ...
                        <div class="row">
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        <?php
                                        $sql = query("SELECT * FROM tbl_doc_awards where doc_award_doc = '$doc_id'");
                                        $i=0;
                                        while ($row = fetch($sql))
                                        {
                                            $i++;
                                            ...
                                            <tr>
                                                <td><?= $i; ?></td>
                                                <td><img style="width:100px;height:auto" src="<?= file_url().$row['doc_award_image'];?>"></td>
                                                <td>
                                                    <a href="<?= admin_base_url();?>model/doctorModel?act=del-award&award_id=<?= $row['doc_award_id']; ?>" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i></a>
                                                </td>
                                            </tr>
                                            <?php
                                        }
