                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        <form  action="<?= admin_base_url()?>model/appointModel" method="POST" enctype="multipart/form-data" class="col-sm-12">
                            ...
                            <input type="hidden" name="txt_depart" value="<?= get_sess("userdata")['doctor_department'];?>">
                            <input type="hidden" value="<?= get_sess("userdata")['doc_id'];?>" name="txt_doctor">
                            <div class="col-sm-6 form-group">
                            ...
                            <div class="col-sm-6 form-group">
                                ...
                                <input type="date" id="date" class="form-control select21" name="txt_date" required>
                            </div>
                            <div class="col-sm-6 form-group">
