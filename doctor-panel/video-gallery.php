...
$sql = query("SELECT * FROM tbl_doc_video where doc_video_doc = '$doc_id'");
?>
                                ...
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = fetch($sql))
                                        {
                                            ...
                                            <tr>
                                                <td><?= $i; ?></td>
                                                <td><img style="width:100px;height:auto" src="https://img.youtube.com/vi/<?= $row['doc_video_code'];?>/0.jpg"></td>
                                                <td>
                                                    <a href="<?= admin_base_url();?>model/doctorModel?act=del-video&vid_id=<?= $row['doc_video_id']; ?>" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i></a>
                                                </td>
                                            </tr>
                                            <?php
                                        }
