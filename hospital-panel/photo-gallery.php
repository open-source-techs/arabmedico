...
$sql = query("SELECT * FROM tbl_hospital_gallery where gall_hospital = '$hospital_id'");
?>
                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        <form  action="<?= admin_base_url()?>model/doctorModel" method="POST" enctype="multipart/form-data" class="col-sm-12">
                            <input type="hidden" name="txt_hospital_id" value="<?= $hospital_id; ?>">
                                ...
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = fetch($sql))
                                        {
                                            ...
                                            <tr>
                                                <td><?= $i; ?></td>
                                                <td><img style="width:100px;height:auto" src="<?= file_url().$row['gall_img'];?>"></td>
                                                <td>
                                                    <a href="<?= admin_base_url();?>model/doctorModel?act=del-img&gall_id=<?= $row['gall_id']; ?>" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i></a>
                                                </td>
                                            </tr>
                                            <?php
                                        }
