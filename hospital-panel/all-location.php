                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <?php
                                    $sql = query("SELECT * FROM tbl_hospital_loc pl JOIN tbl_country cn ON (pl.loc_country = cn.country_id) JOIN tbl_cities c ON (pl.loc_city = c.city_id) JOIN tbl_areas a ON (pl.loc_area = a.area_id) WHERE loc_hospital_id = ".$hospital_id);
                                    while ($row = fetch($sql))
                                    {
                                        ?>
                                        <tr>
