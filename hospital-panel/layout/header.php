...
<head>
    ...
    <title>Arabmedico | hospital Panel</title>
        ...
        <header class="main-header">
            ...
            <nav class="navbar navbar-static-top ">
                ...
                <div class="navbar-custom-menu">
                    <?php 
                    $notifyCountQuery = query("SELECT COUNT(*) as count FROM tbl_notification WHERE notify_user = $hospital_id AND notify_read = 0");
                        ...
                        <li class="dropdown messages-menu">
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <ul class="menu">
                                        <?php 
                                        $notifyDataQuery = query("SELECT * FROM tbl_notification WHERE notify_user = $hospital_id ORDER BY notify_id DESC");
