                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <?php
                                    $sql = query("SELECT * FROM tbl_hospital_slider WHERE slider_hospital = $hospital_id $where LIMIT $offset, $limit");
                                    while ($row = fetch($sql))
                                    {
                                        ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                if($row['slider_is_video'] == 1)
                                                {
                                                    ?>
                                                    <label class="switch">
                                                        <input type="checkbox" <?= ($row['slider_video_show'] == 1) ? 'checked' : ''; ?> class="btn_switch" data-id="<?= $row['slider_id']; ?>" data-hospital-id="<?= $hospital_id; ?>" id="active_home<?= $row['slider_id']; ?>" value="1">
...
<script>
    $(document).ready(function(){
        ...
        $('body').delegate('.btn_switch','change',function(e){
            ...
            var hospital_id   = $(this).attr('data-hospital-id');
            ...
            $.ajax({
                data: {sl_id: slide_id,hospital:hospital_id , action: act, val: value},
                type: "POST",
