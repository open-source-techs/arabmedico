                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <?php
                                    $sql = query("SELECT * FROM tbl_cme_application a JOIN tbl_cme c ON (c.id = a.cme_app_no) WHERE c.cme_organizer = $org_id AND a.cme_app_status = 0");
                                    while ($row = fetch($sql))
                                    {
                                        //echo '<pre>';
                                        //print_r($row);
                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <?php
                                    $sql = query("SELECT * FROM tbl_cme_application a JOIN tbl_cme c ON (c.id = a.cme_app_no) WHERE c.cme_organizer = $org_id AND a.cme_app_status = 1");
                                    while ($row = fetch($sql))
                                    {
                                        //echo '<pre>';
                                        //print_r($row);
                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <?php
                                    $sql = query("SELECT * FROM tbl_cme_application a JOIN tbl_cme c ON (c.id = a.cme_app_no) WHERE c.cme_organizer = $org_id AND a.cme_app_status = 2");
                                    while ($row = fetch($sql))
                                    {
                                        ?>
                                        <tr>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <?php
                                    $sql = query("SELECT * FROM tbl_cme_application a JOIN tbl_cme c ON (c.id = a.cme_app_no) WHERE c.cme_organizer = $org_id AND a.cme_app_status = 3");
                                    while ($row = fetch($sql))
                                    {
                                        ?>
                                        <tr>
