                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <?php
                                    $sql = query("SELECT *, CASE doc_membership WHEN 0 THEN 'Free Member' ELSE m.membership_name END as membership FROM tbl_doctor d JOIN tbl_department td ON (td.dpt_id = d.doctor_department) LEFT JOIN tbl_membership m ON (m.membership_id = d.doc_membership) WHERE 1=1 $where LIMIT $offset, $limit");
                                    while ($row = fetch($sql))
                                    {
                                        ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?= admin_base_url();?>model/doctorModel?act=del&doc_id=<?= $row['doc_id']; ?>" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i>
                                                </a>
                                                <a href="<?= admin_base_url();?>schedule?doc_id=<?= $row['doc_id']; ?>" class="btn btn-warning btn-xs"><i class="fa fa-calendar"></i>
                                                </a>
                                            </td>
                                        </tr>
                                        <?php
