                    ...
                    <div class="panel-body">
                        <form  action="<?= admin_base_url()?>model/scheduleModel" method="POST" enctype="multipart/form-data" class="col-sm-12">
                            ...
                            <div class="dynamic_fields">
                                ...
                                // echo "SELECT * FROM tbl_schedule_time WHERE time_head = '$sch' ORDER BY time_id ASC";
                                if(nrows($sql) > 0)
                                {
                                    // echo "<pre>";
                                    $i = 0;
                                    while ($row = fetch($sql))
                                    {
                                        ...
                                        <div class="div-<?= $i;?>">
                                            <div class="col-md-12">
                                                <button class="btn btn-sm btn-danger pull-right btn_remove_record" type="button" data-remove-id="<?= $row['time_id'];?>"  data-row-id="<?= $i;?>"> Remove Record</button>
                                            </div>
