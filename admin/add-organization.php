...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            <h1>Organization</h1>
            <small>Add New Organization</small>
                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        <form  action="<?= admin_base_url()?>model/organizationModel" method="POST" enctype="multipart/form-data" class="col-sm-12">
                            ...
                            <div class="col-sm-6 form-group">
                                <label>Phone</label>
                                <input type="text" name="txt_org_phone" class="form-control" required>
                            </div>
                            <div class="col-sm-6 form-group">
                            ...
                            <div class="col-sm-6 form-group">
                                <label>Address</label>
                                <textarea name="txt_org_address" class="form-control" required></textarea>
                            </div>
                            <div class="col-sm-6 form-group">
                                <label>Address in Arabic</label>
                                <textarea name="txt_org_address_ar" class="form-control" required></textarea>
                            </div>
                            <div class="col-sm-6 form-group">
                                <label>Country</label>
                            ...
                            <div class="col-sm-6 form-group">
                                ...
                                <input type="text" name="txt_org_url" class="form-control" required>
                            </div>
                            <div class="col-sm-6 form-group">
