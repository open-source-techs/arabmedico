...
// $image_name = upload_image($_FILES,'upload', '../../upload/');


define('NICUPLOAD_PATH', '../../upload/'); // Set the path (relative or absolute) to
                                      // the directory to save image files

define('NICUPLOAD_URI', '../../upload/');   // Set the URL (relative or absolute) to
