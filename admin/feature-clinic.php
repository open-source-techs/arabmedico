...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            <h1>Features</h1>
            <small>Manage Feature Clinic</small>
            <ol class="breadcrumb hidden-xs">
                <li><a href="<?= admin_base_url();?>"><i class="pe-7s-home"></i> Home</a></li>
                <li class="active">Manage Clinic</li>
            </ol>
        </div>
    </section>
    <?php 
    ...
    {
        $f_id = $_GET['f_id'];
        $f_sql = query("SELECT * FROM tbl_feature_clinic WHERE f_id = $f_id");
        $data = fetch($f_sql);
        ?>
                        ...
                        <div class="panel-body">
                            <form  action="<?= admin_base_url()?>model/featureModel" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-sm-6 form-group">
                                        ...
                                        <select name="txt_clinic"  id="doctor" class="form-control select2" required>
                                            ...
                                            {
                                                ?>
                                                <option <?= ($data['f_clinic_id'] == $row['clinic_id']) ? 'selected' : ''; ?> value="<?= $row['clinic_id'];?>"><?= $row['clinic_name'];?></option>
                                                <?php
                                            }
                                            ?>
                                        </select>
                                ...
                                <div class="col-sm-12 reset-button">
                                    <a href="<?= admin_base_url();?>feature-clinic" class="btn btn-warning">Cancel & Go Back</a>
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = fetch($sql))
                                        {
                                            ...
                                            <td><?= ($row['f_home_start'] != null) ? date("d/m/Y",strtotime($row['f_home_start'])) : 'N/A';?></td>
                                                <td>
                                                    <a href="<?= admin_base_url();?>feature-clinic?f_id=<?= $row['f_id']; ?>" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i>
                                                    </a>
