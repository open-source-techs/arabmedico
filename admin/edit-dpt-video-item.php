...
$sql = query("SELECT * FROM tbl_dpt_gallery where dpt_gallery_id = '$gal_id' AND dpt_gallery_depart = '$dpt_id' ");
$gall = fetch($sql);
?>
<style>
    .reset-button{
                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        <form  action="<?= admin_base_url()?>model/departmentModel" method="POST" enctype="multipart/form-data" class="col-sm-12">
                            ...
                            <input type="hidden" value="<?= $gall['dpt_gallery_id'];?>" name="txt_id">
                            <div class="col-sm-6 form-group">
                                <label>Is it a video?</label>
                                <select name="txt_is_video" id="is_video" class="form-control" required>
                                    <option <?= ($gall['dpt_gallery_is_video'] == 0) ? 'selected' : "";?> value="0">No</option>
                                    <option <?= ($gall['dpt_gallery_is_video'] == 1) ? 'selected' : "";?> value="1">Yes</option>
                                </select>
                            </div>
                            <div class="video_div" <?= ($gall['dpt_gallery_is_video'] == 0) ? 'style="display:none;"': '';?>>
                                <div class="col-md-6">
                                    ...
                                    <select name="txt_is_link" id="is_link" class="form-control">
                                        <option <?= ($gall['dpt_gallery_is_link'] == 0) ? 'selected' : "";?> value="0">No</option>
                                        <option <?= ($gall['dpt_gallery_is_link'] == 1) ? 'selected' : "";?> value="1">Yes</option>
                                    </select>
                                </div>
                                <div class="link_div col-md-12" <?= ($gall['dpt_gallery_is_link'] == 0) ? 'style="display:none;"': '';?>>
                                    <div class="col-md-6">
                                        <label>Enter Embbed code here (<b class="text-danger">Please remove styles from IFRAME</b>)</label>
                                        <textarea name="txt_embed_code" id="txt_embed_code"  class="form-control"><?= $gall['dpt_gallery_video'];?></textarea>
                                    </div>
                                    <div class="col-md-6">
                                        <label>Enter Embbed code for Arabic here (<b class="text-danger">Please remove styles from IFRAME</b>)</label>
                                        <textarea name="txt_embed_code_ar" id="txt_embed_code_ar"  class="form-control"><?= $gall['dpt_gallery_video_ar'];?></textarea>
                                    </div>
                                </div>
                                <div class="input_vid col-md-12" <?= ($gall['dpt_gallery_is_link'] == 1) ? 'style="display:none;"': '';?>>
                                    <div class="col-md-6 ">
                            ...
                            <div class="image_div" <?= ($gall['dpt_gallery_is_video'] == 1) ? 'style="display:none;"': '';?>>
                                <div class="col-sm-6 form-group">
                            ...
                            <div class="col-sm-6 form-group">
                                ...
                                <select name="txt_is_active" class="form-control">
                                    <option <?= ($gall['dpt_gallery_active'] == 0) ? 'selected' : "";?> value="0">No</option>
                                    <option <?= ($gall['dpt_gallery_active'] == 1) ? 'selected' : "";?> value="1">Yes</option>
                                </select>
                            </div>
