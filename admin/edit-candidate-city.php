...
if($city_id == 0 || $city_id == '' || $city_id < 0)
{
    ?>
    <script>
      window.location.href="<?php echo admin_base_url(); ?>candidate-city";
    </script>
    <?php
}
$sql = query("SELECT * FROM tbl_candidate_cities where city_id = '$city_id'");
$city = fetch($sql);
?>
            ...
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="btn-group"> 
                            <a class="btn btn-primary" href="<?= admin_base_url();?>candidate-city"> <i class="fa fa-list"></i> city List </a>  
                        </div>
                    </div>
                    <div class="panel-body">
                        <form  action="<?= admin_base_url()?>model/candidateModel" method="POST" enctype="multipart/form-data" class="col-sm-12">
                            ...
                            <div class="col-sm-12 reset-button">
                                <a href="<?= admin_base_url();?>candidate-city" class="btn btn-warning">Cancel & Go Back</a>
