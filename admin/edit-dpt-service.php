...
$sql = query("SELECT * FROM tbl_dpt_service WHERE dpt_service_id = ".$service);
$data = fetch($sql);
?>
                    ...
                    <div class="panel-body">
                        <form  action="<?= admin_base_url()?>model/departmentModel" method="POST" enctype="multipart/form-data" class="col-sm-12">
                            ...
                            <div class="col-sm-12 reset-button">
                                <a href="<?= admin_base_url();?>dpt-service-panel?dpt_id=<?= $dpt_id; ?>" class="btn btn-warning">Cancel & Go Back</a>
