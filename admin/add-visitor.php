                    ...
                    <div class="panel-body">
                        <form  action="<?= admin_base_url()?>model/visitorModel" onsubmit="return checkPass()" method="POST" enctype="multipart/form-data" class="col-sm-12">
                            <div class="col-sm-6 form-group">
                                ...
                                <input type="text" name="txt_full_name" class="form-control" placeholder="Enter Full Name" required>
                            </div>
                            <div class="col-sm-6 form-group">
                                <label>Full Name Arabic</label>
                                <input type="text" name="txt_full_name_arabic" class="form-control" placeholder="Enter Full Name In Arabic" required>
                            </div>
                            <div class="col-sm-6 form-group">
                                <label>Profile image</label>
                                <label class="txt_icon"></label>
                                <input type="file" name="txt_icon" onchange="checkFileSize('txt_icon');" id="txt_icon" class="form-control" required>
                            </div>
                            <div class="col-sm-6 form-group">
                                <label>Phone Number</label>
                                <input type="tel" name="txt_phone" class="form-control" placeholder="Enter Phone Number" required>
                            </div>
                            <div class="col-sm-6 form-group">
                                <label>Phone Number In Arabic</label>
                                <input type="tel" name="txt_phone_arabic" class="form-control" placeholder="Enter Phone Number In Arabic" required>
                            </div>
                            <div class="col-sm-6 form-group">
                                <label>Email</label>
