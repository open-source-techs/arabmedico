                    ...
                    <div class="panel-body">
                        <form  action="<?= admin_base_url()?>model/hospitalModel" method="POST" enctype="multipart/form-data" class="col-sm-12">
                            <div class="col-sm-6 form-group">
                                <label>Name</label>
                                <input type="text" name="txt_hospital_name" class="form-control" required>
                            </div>
                            <div class="col-sm-6 form-group">
                                <label>Name in Arabic</label>
                                <input type="text" name="txt_hospital_name_ar" class="form-control" required>
                            </div>
                            <div class="col-sm-6 form-group">
                                <label>Phone</label>
                                <input type="text" name="txt_hospital_phone" class="form-control" required>
                            </div>
                            <div class="col-sm-6 form-group">
                            ...
                            <div class="col-sm-6 form-group">
                                <label>Address</label>
                                <textarea name="txt_hospital_address" class="form-control" required></textarea>
                            </div>
                            <div class="col-sm-6 form-group">
                                <label>Address in Arabic</label>
                                <textarea name="txt_hospital_address_ar" class="form-control" required></textarea>
                            </div>
                            <div class="col-sm-6 form-group">
                                <label>Country</label>
                            ...
                            <div class="col-sm-6 form-group">
                                ...
                                <input type="text" name="txt_hospital_url" class="form-control">
                            </div>
                            <div class="col-sm-6 form-group">
                            ...
                            <div class="col-sm-6 form-group">
                                ...
                                <input type="text" name="txt_hospital_url" class="form-control" required>
                            </div>
                            <div class="col-sm-6 form-group">
                            ...
                            <div class="col-sm-12 reset-button">
                                ...
                                <input type="submit" name="btn_save_hospital" class="btn btn-success" value="Save">
                            </div>
                        </form>
                    </div>
                </div>
