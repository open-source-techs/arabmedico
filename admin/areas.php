                    ...
                    <div class="panel-body">
                        <form  action="<?= admin_base_url()?>model/locationModel" method="POST" enctype="multipart/form-data" class="col-sm-12">
                            <div class="col-sm-6 form-group">
                                ...
                                <input type="text" name="area_name" class="form-control" placeholder="Enter Country Name" required>
                            </div>
                            <div class="col-sm-6 form-group">
                                <label>area Name Arabic</label>
                                <input type="text" name="area_name_ar" class="form-control" placeholder="Enter Country Name Arabic" required>
                            </div>
                            <div class="col-sm-6 form-group">
