...
$cntctSql = query("SELECT * FROM tbl_user_contact WHERE my_id = '$doctorID' AND my_type = 'clinic'");
$mycontacts = array();
                        ...
                        <div class="chat_window body" id="chat_window">
                            ...
                            if(isset($_GET['IdChat']))
                            {
                                ...
                                <ul class="chat-history">
                                    <?php
                                    $msgsql = query("SELECT * FROM tbl_chat WHERE (sender = $senderID AND receiver = $doctorID AND receiver_type = 'clinic' AND sender_type = '$sender_type') AND (sender = $doctorID AND receiver = $senderID AND receiver_type = '$sender_type' AND sender_type = 'clinic') ORDER BY chat_id ASC");
