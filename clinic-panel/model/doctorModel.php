...
if($_SERVER['REQUEST_METHOD'] == "POST")
{
    ...
    {
        $data['doc_clinic']         = post('clinic_id');
		...
		if(
		    $data['doc_clinic']         != null && $data['doc_clinic']          != "" &&
	...
	{
	    $data['loc_clinic_id']      = post('clinic_id');
	...
	{
	    $data['gall_clinic'] 	= post('txt_clinic_id');
		$image_name             = upload_image($_FILES,'txt_image', '../../upload/');
		if($image_name)
		{
		    $data['gall_img'] 	= $image_name;
		    if(insert($data,'tbl_clinic_gallery'))
    		{
	...
	{
	    $data['video_clinic']   = post('txt_clinic_id');
	    $data['video_code']     = post('txt_video');
	    if(insert($data,'tbl_clinic_video'))
		{
