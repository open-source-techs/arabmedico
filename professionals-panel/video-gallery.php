...
$sql = query("SELECT * FROM tbl_can_video where can_video_doc = '$doc_id'");
?>
                                ...
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = fetch($sql))
                                        {
                                            ...
                                            <tr>
                                                <td><?= $i; ?></td>
                                                <td><img style="width:100px;height:auto" src="https://img.youtube.com/vi/<?= $row['can_video_code'];?>/0.jpg"></td>
                                                <td>
                                                    <a href="<?= admin_base_url();?>model/candidateModel?act=del-video&vid_id=<?= $row['can_video_id']; ?>" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i></a>
                                                </td>
                                            </tr>
                                            <?php
                                        }
