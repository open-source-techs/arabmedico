...
$sql = query("SELECT * FROM tbl_can_gallery where can_gall_canID = '$doc_id'");
?>
                                ...
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = fetch($sql))
                                        {
                                            ...
                                            <tr>
                                                <td><?= $i; ?></td>
                                                <td><img style="width:100px;height:auto" src="<?= file_url().$row['can_gall_img'];?>"></td>
                                                <td>
                                                    <a href="<?= admin_base_url();?>model/candidateModel?act=del-img&gall_id=<?= $row['can_gall_id']; ?>" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i></a>
                                                </td>
                                            </tr>
                                            <?php
                                        }
