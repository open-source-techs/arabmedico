                        ...
                        if(isset($_GET['jobTitle']) || isset($_GET['speciality']) || isset($_GET['location']))
                        {
                            ...
                            <div class="list-wrapper">
                                ...
                                $userSQl  = query("SELECT * FROM 
                                    ...
                                    OR c.city_name LIKE '%".$location."%') AND clinic_id != ".$organizationID."  GROUP BY clinic_id");
                                while($data = fetch($userSQl))
                                {
                                    foreach($mycontacts as $contact)
                                    {
            ...
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        <div class="list-wrapper">
                            <?php
                            $cntctSql = query("SELECT * FROM tbl_user_contact WHERE my_id = '$organizationID' AND my_type = 'organization' AND active = 1");
