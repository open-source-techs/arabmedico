                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <?php
                                    $sql = query("SELECT * FROM tbl_org_slider WHERE slider_org = $org_id $where LIMIT $offset, $limit");
                                    while ($row = fetch($sql))
                                    {
                                        ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                if($row['slider_is_video'] == 1)
                                                {
                                                    ?>
                                                    <label class="switch">
                                                        <input type="checkbox" <?= ($row['slider_video_show'] == 1) ? 'checked' : ''; ?> class="btn_switch" data-id="<?= $row['slider_id']; ?>" data-clinic-id="<?= $org_id; ?>" id="active_home<?= $row['slider_id']; ?>" value="1">
                        ...
                        <div class="page-nation text-right">
                            ...
                            <ul class="pagination pagination-large">
                                <?php
							    $total_pages_sql = query("SELECT count(*) as count FROM tbl_org_slider where slider_org = $org_id $where");
...
<script>
    $(document).ready(function(){
        ...
        $('body').delegate('.btn_switch','change',function(e){
            ...
            $.ajax({
                data: {sl_id: slide_id, org:clinic_id , action: act, val: value},
                type: "POST",
