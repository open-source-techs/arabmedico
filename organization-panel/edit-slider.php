...
if($sli_id == 0 || $sli_id == '' || $sli_id < 0)
{
    ?>
    <script>
      window.location.href="<?php echo admin_base_url(); ?>slider";
    </script>
    <?php
}
$sql = query("SELECT * FROM tbl_clinic_slider where slider_id = '$sli_id'");
$dpt = fetch($sql);
?>
<style>
    .reset-button{
                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        <form  action="<?= admin_base_url()?>model/sliderModel" method="POST" enctype="multipart/form-data" class="col-sm-12">
                            <input type="hidden" value="<?= $org_id; ?>" name="txt_org_id" >
