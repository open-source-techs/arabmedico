...
<?php 
if(get_sess('organization_logged_in') != 1)
{
    jump(admin_base_url()."login");
}
$clinic_id = get_sess('userdata')['organization_id'];
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Arabmedico | Organization Panel</title>
        ...
        <header class="main-header">
            ...
            <nav class="navbar navbar-static-top ">
                ...
                <div class="navbar-custom-menu">
                    <?php 
                    $notifyCountQuery = query("SELECT COUNT(*) as count FROM tbl_notification WHERE notify_user = $clinic_id AND notify_read = 0");
